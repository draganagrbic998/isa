		...
		<div class="registracija">
			...
			<div>
				...
				<table>
					...
					<tr><td class="left">Drzava: </td><td class="right"><input type="text" v-model="klinika.novaDrzava"></td><td>{{greskaDrzava}}</td></tr>
					<tr><td class="left">Grad: </td><td class="right"><input type="text" v-model="klinika.noviGrad"></td><td>{{greskaGrad}}</td></tr>
					<tr><td class="left">Adresa: </td><td class="right"><input type="text" v-model="klinika.novaAdresa"></td><td>{{greskaAdresa}}</td></tr>
					<br>
