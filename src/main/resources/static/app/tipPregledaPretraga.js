Vue.component('tipPregledaPretraga', {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<table class="table">
		...
		<tr v-for="t in tipoviPregleda">
			...
			<td><button v-on:click="deleteTP(t.id)" class="btn"><i class="fa fa-trash "></i>Obrisi</button></td></tr>
	</table>	
		<h3>{{nemaRezultata}}</h3>
		</div>
	...
	methods: {
		...
		deleteTP: function(id) {
			...
			.then(response => {
				alert("Tip posete " + id + " uspesno obrisan!");
